...
| Observability | Partial | Application `/metrics` exposes request/error, HTTP/tool/retrieval/LLM latency, and streaming TTFT metrics; vLLM/GPU scraping and Grafana are still pending. |
