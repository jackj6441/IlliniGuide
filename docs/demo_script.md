...
The repository skeleton exists. The backend API skeleton is implemented with mocked responses. Frontend UI, real RAG, tool routing, vLLM integration, and metrics are not implemented yet.
